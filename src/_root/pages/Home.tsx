...
import brandOne from "../../assets/brands/01.svg";
import brandTwo from "../../assets/brands/02.svg";
import brandThree from "../../assets/brands/03.svg";
import brandFour from "../../assets/brands/04.svg";
    ...
    <div className="home-page">
      ...
      <div className="service__container">
        {services.map((service) => {
          return (
            <div key={service.name} className="service__container-1">
              <div className="square"></div>
              <img
                className="service__container-1-img"
                alt="service"
      ...
      <div className="brands__container">
        <img className="brands__container-item" alt="brand" src={brandOne} />
        <img className="brands__container-item" alt="brand" src={brandTwo} />
        <img className="brands__container-item" alt="brand" src={brandThree} />
        <img className="brands__container-item" alt="brand" src={brandFour} />
      </div>
